...
function initLevel() {
    ...
    try {
        ...
        // First ladder (top of bottom platform, y: 668, extends up to top of second platform, y: 568)
        ladders.push({ x: 506, y: baseY[0] - 100, width: 50, height: 100, image: null }); // y: 568 (extends from 668 to 568)
        // Second ladder (top of second platform, y: 568, extends up to top of third platform, y: 468)
        ladders.push({ x: 94, y: baseY[1] - 100, width: 50, height: 100, image: null }); // y: 468 (extends from 568 to 468)
        // Third ladder (top of third platform, y: 468, extends up to top of top platform, y: 368)
        ladders.push({ x: 506, y: baseY[2] - 100, width: 50, height: 100, image: null }); // y: 368 (extends from 468 to 368)
