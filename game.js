...
function initLevel() {
 ...
 if (level === 1) {
 platforms = [
 { x: 0, y: h - 50, width: w * 0.3, height: 20, image: images.platform },
 { x: w * 0.7, y: h - 50, width: w * 0.3, height: 20, image: images.platform },
 { x: 0, y: h - 250, width: w * 0.5, height: 20, image: images.platform },
 { x: w * 0.5, y: h - 250, width: w * 0.5, height: 20, image: images.platform },
 { x: 0, startY: h - 600, width: w, height: 20, slope: 0.1, image: images.platform }
 ];
 ladders = [
 { x: w * 0.27, y: h - 230, width: 50, height: 180, image: images.ladder },
 { x: w * 0.67, y: h - 230, width: 50, height: 180, image: images.ladder },
 { x: w * 0.47, y: h - 580, width: 50, height: 180, image: images.ladder }
 ];
 rivets = [
 { x: w * 0.07, y: h - 70, width: 20, height: 20, hit: false, image: images.rivet },
 { x: w * 0.22, y: h - 70, width: 20, height: 20, hit: false, image: images.rivet },
 { x: w * 0.77, y: h - 70, width: 20, height: 20, hit: false, image: images.rivet },
 { x: w * 0.92, y: h - 70, width: 20, height: 20, hit: false, image: images.rivet },
 ...
 platforms = [
 { x: 0, y: h - 50, width: w * 0.45, height: 20, image: images.platform },
 { x: w * 0.55, y: h - 50, width: w * 0.45, height: 20, image: images.platform },
 { x: 0, y: h - 300, width: w * 0.3, height: 20, image: images.platform },
 { x: w * 0.7, y: h - 300, width: w * 0.3, height: 20, image: images.platform },
 { x: 0, startY: h - 600, width: w, height: 20, slope: 0.1, image: images.platform }
 ];
 ladders = [
 { x: w * 0.39, y: h - 30, width: 50, height: 180, image: images.ladder },
 { x: w * 0.94, y: h - 280, width: 50, height: 180, image: images.ladder },
 { x: w * 0.07, y: h - 580, width: 50, height: 180, image: images.ladder },
 { x: w * 0.92, y: h - 580, width: 50, height: 180, image: images.ladder }
 ];
 rivets = [
 { x: w * 0.07, y: h - 70, width: 20, height: 20, hit: false, image: images.rivet },
 { x: w * 0.22, y: h - 70, width: 20, height: 20, hit: false, image: images.rivet },
 { x: w * 0.63, y: h - 70, width: 20, height: 20, hit: false, image: images.rivet },
 { x: w * 0.77, y: h - 70, width: 20, height: 20, hit: false, image: images.rivet },
 ...
 platforms = [
 { x: 0, y: h - 50, width: w * 0.37, height: 20, image: images.platform },
 { x: w * 0.63, y: h - 50, width: w * 0.37, height: 20, image: images.platform },
 { x: 0, startY: h - 300, width: w * 0.5, height: 20, slope: 0.1, image: images.platform },
 { x: w * 0.5, y: h - 300, width: w * 0.5, height: 20, image: images.platform },
 { x: 0, startY: h - 600, width: w, height: 20, slope: 0.1, image: images.platform }
 ];
 ladders = [
 { x: w * 0.33, y: h - 30, width: 50, height: 180, image: images.ladder },
 { x: w * 0.9, y: h - 280, width: 50, height: 180, image: images.ladder },
 { x: w * 0.47, y: h - 580, width: 50, height: 180, image: images.ladder }
 ];
 rivets = [
 { x: w * 0.07, y: h - 70, width: 20, height: 20, hit: false, image: images.rivet },
 { x: w * 0.22, y: h - 70, width: 20, height: 20, hit: false, image: images.rivet },
 { x: w * 0.7, y: h - 70, width: 20, height: 20, hit: false, image: images.rivet },
 { x: w * 0.85, y: h - 70, width: 20, height: 20, hit: false, image: images.rivet },
 ...
 { x: w * 0.7, y: h - 50, width: w * 0.3, height: 20, image: images.platform },
 { x: 0, startY: h - 300, width: w * 0.5, height: 20, slope: 0.1, image: images.platform },
 { x: w * 0.5, startY: h - 300, width: w * 0.5, height: 20, slope: -0.1, image: images.platform },
 { x: 0, startY: h - 600, width: w, height: 20, slope: 0.1, image: images.platform }
 ];
 ladders = [
 { x: w * 0.27, y: h - 30, width: 50, height: 180, image: images.ladder },
 { x: w * 0.97, y: h - 280, width: 50, height: 180, image: images.ladder },
 { x: w * 0.47, y: h - 580, width: 50, height: 180, image: images.ladder },
 { x: w * 0.07, y: h - 580, width: 50, height: 180, image: images.ladder }
 ];
 rivets = [
...
function update(canvas) {
 ...
 if (checkCollision(mario, p) && mario.y + mario.height <= platformY + p.height) { // Relaxed collision
 ...
 mario.dy = 0;
 mario.groundY = mario.y;
 onPlatform = true; // Treat base as platform
 }
...
function checkCollision(obj1, obj2) {
 ...
 // Widen ladder collision slightly
 const ladderBuffer = obj2.width === 50 ? 10 : 0; // For ladders only
